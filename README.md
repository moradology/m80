...
Public installer status: public proof green for `v0.2.9`. Latest and pinned install URLs were verified from unauthenticated public release assets. Proof: [latest-and-pinned-url-proof](docs/behaviors/release/release-readiness-public-access.json).
