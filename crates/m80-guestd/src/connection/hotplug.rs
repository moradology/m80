...
use m80_proto::{
    DriveHotplugError, DriveMountRequest, DriveMountResponse, DriveMountSpec, DriveMountStatus,
    DriveMountStatusKind, RawEnvelope, TenantIdentityReport, PAYLOAD_KIND_DRIVE_MOUNT_REQUEST,
};
...
pub(super) fn is_hotplug_kind(kind: &str) -> bool {
    kind == PAYLOAD_KIND_DRIVE_MOUNT_REQUEST
}
