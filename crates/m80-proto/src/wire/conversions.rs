...
use crate::types::{
    CancelRequest, CancelResponse, CancelStatus, ExecExit, ExecRequest, ExecResponse, ExecStatus,
    ExecStderr, ExecStdout, ExecTiming, FileError, FileKind, GuestCpuMetrics, GuestMemMetrics,
...
fn payload_name(payload: &WirePayload) -> &'static str {
    match payload {
        ...
        WirePayload::FileMkdirRequest(_) => "file_mkdir_request",
        WirePayload::FileMkdirResponse(_) => "file_mkdir_response",
