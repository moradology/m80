...
impl WarmErrorKind {
    fn from_error(err: &FcError) -> Self {
        match err {
            ...
            FcError::NetworkHelper(_) => Self::NetworkHelper,
            FcError::CapabilityDrop(_) => Self::CapabilityDrop,
            ...
            FcError::StaleCgroupLeaf { .. } => Self::StaleCgroupLeaf,
            ...
            FcError::CleanupDeadlineExceeded { .. } => Self::CleanupDeadlineExceeded,
