...
bind the attestation bundle to the predicate. Each failure prints a repair hint
to retry the pinned release installer or inspect that release's asset list; it
does not direct operators to fetch mutable branch scripts. Its human output
includes the resolved release tag, source commit,
